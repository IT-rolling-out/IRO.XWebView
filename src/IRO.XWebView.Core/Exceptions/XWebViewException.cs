...
namespace IRO.XWebView.Core.Exceptions
{
    public class XWebViewException : Exception
    {
        ...
        protected XWebViewException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public XWebViewException(string message) : base(message)
        {
        }
        ...
        public XWebViewException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}