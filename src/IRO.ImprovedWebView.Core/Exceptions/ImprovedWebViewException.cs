...
namespace IRO.ImprovedWebView.Core.Exceptions
{
    public class ImprovedWebViewException : Exception
    {
        /// <summary>Initializes a new instance of the <see cref="T:System.Exception"></see> class.</summary>
        public ImprovedWebViewException()
        {
        }
        ...
        protected ImprovedWebViewException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public ImprovedWebViewException(string message) : base(message)
        {
        }
        ...
        public ImprovedWebViewException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}