...
namespace IRO.ImprovedWebView.Core.Exceptions
{
    public class BindingJsSystemException:Exception
    {
        ...
        protected BindingJsSystemException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public BindingJsSystemException(string message) : base(message)
        {
        }
        ...
        public BindingJsSystemException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
